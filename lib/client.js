...
function Client (connectionString, clientId, zkOptions, noAckBatchOptions, sslOptions) {
  ...
  this.preferredListenerName = zkOptions ? zkOptions.preferredListenerName : undefined;
    ...
    if (brokerProfile.endpoints && brokerProfile.endpoints.length) {
      var endpoint = _.find(brokerProfile.endpoints, function (endpoint) {
        ...
        if (securityProtocolMap !== undefined) {
            var matchesProtocol = securityProtocolMap[listenerName] === protocol;
            if (self.preferredListenerName !== undefined)
              return matchesProtocol && listenerName === self.preferredListenerName;
            else
